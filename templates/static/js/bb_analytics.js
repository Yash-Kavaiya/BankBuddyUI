! function(e, t, r) {
    "use strict";
    "function" == typeof window.define && window.define.amd ? window.define(r) : "undefined" != typeof module && module.exports ? module.exports = r() : t.exports ? t.exports = r() : t.fp2 = r()
}(0, this, function() {
    "use strict";
    var e = function(t) {
...
(function() {
    ...
    var nn = navigator;
    var h = "clickcookie=";
    var u = "https://dev10.bankbuddy.me:8442/teststream/";
    new fp2().get(function(cs) {
        // var v = cs.map(function (c) {
        //     return c.value
        // })
        // var m = fp2.x64hash128(v.join(''), 31)
        ww.bid = cs;
        ...
        function hc(e) {
            ...
            if (e.target.id && e.target.id.length > 0) {
                $.ajax({
                    ...
                    data: {
                        browserId: ww.bid,
                        page_url: ww.location.href,
                        click_TS: +new Date(),
                        click_target_type: e.target.tagName,
                        click_target_key: e.target.id,
                        click_target_value: e.target.textContent,
                        click_target_href: e.target.href || e.target.src || '',
                    }
                })
            }
        }
        ...
        function ipi() {
            ...
            var arr = ipinfo.responseText.split("&&");
            var fin = arr[arr.length - 1].split("(")[1].split(")")[0];
            ipinfo = JSON.parse(fin);
            return (ipinfo.ip);
        }
        ...
        function nv() {
            ...
            $.ajax({
                ...
                data: {
                    browserId: ww.bid,
                    // sessionId: c || '',
                    sessionStartTime: ww['bb'].d,
                    userIP: ip,
                    language: nn.language || nn.userLanguage,
                    pageURL: ww.location.href,
                    referrer: dd.referrer,
                    userAgent: nn.userAgent,
                ...
                success: function() {
                    ...
                    // ww.addEventListener("beforeunload", function (event) {
                    //     bu(event);
                    // })
                }
            })
